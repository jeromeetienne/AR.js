...
Stuff is still moving fast, We reached a good status tho.
An article has been published in [uploadvr](https://uploadvr.com/ar-js-efficient-augmented-reality-for-the-web/).
...
It works on all platforms. Android, IOS and window phone. It runs **any browser with WebGL and WebRTC**.
...
**You are done!** It will open a webpage which read the phone webcam, localize a hero marker and add 3d on top of it, as you can see below.

![screenshot](https://cloud.githubusercontent.com/assets/252962/23072106/73a0656c-f528-11e6-9fcd-3c900d1d47d3.jpg)

# Standing on the Shoulders of Giants

So we showed it is now possible to do 60fps web-based augmented reality on a phone.
This is great for sure but how did we get here? **By standing on the shoulders of giants!**
It is thanks to the hard work of others, that we can today reach this mythic 60fps AR.
...
# Posts on medium
We started an [AR.js blog](https://medium.com/arjs), thus we can write about
...
It explains how to code a full application on phone! Step by Steps, with explanation and videos. 
...
We did well on performance, but there are still a lot of room for optimisation.
...
I would like people to start experience augmented reality and play with it.
...
- **Desktop Chrome with the webcam and 2 tabs** (one for Hero, one for the result) (works!)
