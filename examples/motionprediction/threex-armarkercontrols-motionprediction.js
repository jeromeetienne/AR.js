...
THREEx.ArMarkerControls = function(context, object3d, parameters){
	...
	this.parameters = {
		...
		// enable motion prediction - default to true 
		motionPredictionEnabled : parameters.motionPredictionEnabled !== undefined ? parameters.motionPredictionEnabled : false,
	}
	...
	// init the object which follow the marker - directly out of artoolkit
	this._markerObject3D = new THREE.Group
	this._markerObject3D.matrixAutoUpdate = false;
	
	// init MotionPredictionControls
	this._motionPredictionControls = new THREEx.MotionPredictionControls(this.object3d)
	this._motionPredictionControls.enabled = this.parameters.motionPredictionEnabled
...
THREEx.ArMarkerControls.prototype._postInit = function(){
	...
	var markerObject3D = this._markerObject3D;
	// check if arController is init
	...
	arController.addEventListener('getMarker', function(event){
		...
		function onMarkerFound(){
			...
			// set this position as a knownPosition in _motionPredictionControls
			_this._motionPredictionControls.setKnownPose(markerObject3D.position, markerObject3D.quaternion, markerObject3D.scale)

		// console.log('onMarkerFound')

			// console.log('position', _this.object3d.position)
			// console.log('quaternion', _this.object3d.quaternion)
			
			// _this.object3d.updateMatrix(true)
			// _this.object3d.updateMatrixWorld(true)
			// _this._markerObject3D.updateMatrix(true)
			// _this._markerObject3D.updateMatrixWorld(true)
		}
	})
}
...
//		Code Separator
//////////////////////////////////////////////////////////////////////////////
THREEx.ArMarkerControls.prototype.update = function(){
	// update motion prediction controls
	this._motionPredictionControls.update()
}
